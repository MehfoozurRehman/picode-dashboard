...
function NotificationsTableEntry({ onEdit, onDelete }) {
  return (
    <div className="main__content__table__list">
      ...
      <div className="main__content__table__list__entry">Al Bashir Shumail</div>
      <div className="main__content__table__list__entry">
      ...
      <div className="main__content__table__list__entry">10/3/2020</div>
    </div>
  );
}
    ...
    <div className="main">
      <div className="main__header">
        <div className="main__header__top">
          <div className="main__header__top__heading">Notifications</div>
      ...
      <div className="main__content">
        <div className="main__content__table">
          <div className="main__content__table__header">
            ...
            <TableHeaderEntry title="Notification Title" />
