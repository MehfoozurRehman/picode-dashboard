...
function PaymentHistoryTableEntry({ onEdit, onDelete }) {
  return (
...
export default function PaymentHistory({ onAdd, onEdit, onDelete }) {
  return (
    <div className="main">
      ...
      <div className="main__content">
        <div className="main__content__table">
          ...
          <PaymentHistoryTableEntry onEdit={onEdit} onDelete={onDelete} />
          <PaymentHistoryTableEntry onEdit={onEdit} onDelete={onDelete} />
          <PaymentHistoryTableEntry onEdit={onEdit} onDelete={onDelete} />
          <PaymentHistoryTableEntry onEdit={onEdit} onDelete={onDelete} />
          <PaymentHistoryTableEntry onEdit={onEdit} onDelete={onDelete} />
